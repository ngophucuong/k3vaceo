...
--
-- Gồm 12 migration: 0001_init.sql, 0002_seed_roster.sql, 0003_seed_group6.sql, 0004_invite_kind_and_rate_limit.sql, 0005_webauthn_challenges.sql, 0006_wizard_and_presentation.sql, 0007_otp_and_self_onboarding.sql, 0008_fund_expenses.sql, 0009_phone_self_set.sql, 0010_khai_ho_va_quy_cap.sql, 0011_lich_hoc.sql, 0012_thong_bao_nhom_va_push.sql
-- ═══════════════════════════════════════════════════════════════
